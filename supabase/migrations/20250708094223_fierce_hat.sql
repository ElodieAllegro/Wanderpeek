/*
  # Complete Wanderpeek Database Schema

  1. New Tables
    - `users` - User accounts (admin, hotelier, client)
    - `hotels` - Hotel listings with status management
...
-- Create basic availability entries for approved hotels (simplified approach)
-- We'll create a few sample entries instead of generating the full 2-month calendar
INSERT INTO availabilities (hotel_id, date, is_available, price_override) VALUES
  -- Hôtel du Vieux-Port
  ('10000000-0000-0000-0000-000000000001', CURRENT_DATE + INTERVAL '1 day', true, null),
  ('10000000-0000-0000-0000-000000000001', CURRENT_DATE + INTERVAL '2 days', true, null),
  ('10000000-0000-0000-0000-000000000001', CURRENT_DATE + INTERVAL '3 days', true, null),
  ('10000000-0000-0000-0000-000000000001', CURRENT_DATE + INTERVAL '4 days', false, null),
  ('10000000-0000-0000-0000-000000000001', CURRENT_DATE + INTERVAL '9 days', true, 102.00), -- Weekend premium
  ('10000000-0000-0000-0000-000000000001', CURRENT_DATE + INTERVAL '10 days', true, 102.00), -- Weekend premium
  
  -- Villa Océan Biarritz
  ('10000000-0000-0000-0000-000000000002', CURRENT_DATE + INTERVAL '1 day', true, null),
  ('10000000-0000-0000-0000-000000000002', CURRENT_DATE + INTERVAL '2 days', true, null),
  ('10000000-0000-0000-0000-000000000002', CURRENT_DATE + INTERVAL '3 days', true, null),
  ('10000000-0000-0000-0000-000000000002', CURRENT_DATE + INTERVAL '9 days', true, 300.00), -- Weekend premium
  ('10000000-0000-0000-0000-000000000002', CURRENT_DATE + INTERVAL '10 days', true, 300.00), -- Weekend premium
  
  -- Hôtel Montmartre Charme
  ('10000000-0000-0000-0000-000000000003', CURRENT_DATE + INTERVAL '1 day', true, null),
  ('10000000-0000-0000-0000-000000000003', CURRENT_DATE + INTERVAL '2 days', true, null),
  ('10000000-0000-0000-0000-000000000003', CURRENT_DATE + INTERVAL '3 days', true, null),
  ('10000000-0000-0000-0000-000000000003', CURRENT_DATE + INTERVAL '9 days', true, 144.00), -- Weekend premium
  ('10000000-0000-0000-0000-000000000003', CURRENT_DATE + INTERVAL '10 days', true, 144.00); -- Weekend premium
